...
\caption{List of the best GP models for different diffusivity measures and window segments. Only models with at least 70\% accuracy were accepted. Precision and f1 scores are also provided for reference}
\label{table:GP}
\end{table}
